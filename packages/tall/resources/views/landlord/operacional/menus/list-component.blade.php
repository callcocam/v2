<x-slot name="header">
    <x-tall-table.breadcrumbs url="{{ route($this->list) }}" label="{{ __('Menus') }}" />
                ...
                <div class="bg-white shadow-md rounded px-4">
                    <div class="sm:flex sm:items-center px-6 pt-6 pb-4">
                        <div class="sm:flex-auto">
                            <h1 class="text-xl font-semibold text-gray-900">{{ __('Menus') }}</h1>
                            @isset($description)
                                ...
                                <th class="py-1 px-6 text-left  cursor-pointer">
                                    <div class="flex flex-col space-y-1">
                                        <x-tall-table.sort name="name">{{ __('Nome') }}</x-tall-table.sort>
                                         {{-- <x-form.select name="role" :options="$this->options" /> --}}
                                    </div>
                                </th>
