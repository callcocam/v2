...
use Tall\Models\Auth\Acl\Contracts\Role;
...
trait HasRoles
{
  /**
    ...
    {
        return $this->belongsToMany(config('tall.models.role'),'role_user','user_id')->withTimestamps();
    }
    ...
    {
        return app()->make(config('tall.models.role'));
    }
}
