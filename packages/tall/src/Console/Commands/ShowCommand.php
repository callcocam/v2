...
class ShowCommand extends MakeCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'make:show {name} {model} {--force} {--inline} {--test} {--stub }';
    ...
    public function handle()
    {
        $this->parser = new ComponentParser(
            ...
            sprintf("admin.%s.show-component", $this->argument('name')),
            $this->argument('model'),
            $this->option('stub')
        );
    ...
    protected function createClass($force = false, $inline = false)
    {
        ...
        File::put($classPath, $this->parser->classContents("show"));
    ...
    protected function createView($force = false, $inline = false)
    {
        ...
        File::put($viewPath, $this->parser->viewContents('show'));
