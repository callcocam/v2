...
use Tall\Tenant\Exceptions\ModelNotFoundForTenantException;
...
trait BelongsToTenants
{
    ...
    {
        return isset($this->tenantColumns) ? $this->tenantColumns : config('tall.multitenancy.default_tenant_columns');
    }
